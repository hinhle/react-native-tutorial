    ...
    data: [
      {
        name: "AngularJS",
        description:
          "An incredibly robust JavaScript framework for data-heavy sites",
      },
      {
        name: "JQuery",
        description:
          "A fast, small, JS object library that streamlines how JavaScript behaves across different browsers",
      },
      {
        name: "React",
  ...
  },
  {
    data: [
      ...
      },
      {
        name: "Wise.io",
        description:
          "Wise.io also aims to democratise the use of artificial intelligence with 'machine learning as a service'",
      },
      {
        name: "Neon",
        description:
